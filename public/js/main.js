!function() {
  ...
  3: [function(require, module, exports) {
      ...
      exports.setReferral = function() {
          if (!cookies.get("referral")) {
              ...
              !window.meta.currentUserId.length && query.ref && (cookies.set("referral", query.ref),
              ...
              query.campaign && (cookies.set("campaign", query.campaign),
  ...
  4: [function(require, module, exports) {
      var cookies = (require("query-string"),
      require("js-cookie"));
  ...
  5: [function(require, module, exports) {
      ...
      exports.checkQuestions = function() {
          $("#questionsSubmit").prop("disabled", !0),
          $("#questionsError").hide(),
          ...
          "exam" === questions.questionType && $("html, body").animate({
              scrollTop: 0
          }, "fast");
          var radios = $(":radio")
            , radioArray = [];
          $.each(radios, function(i) {
              -1 === $.inArray(radios[i].name, radioArray) && radioArray.push(radios[i].name)
          });
          var answers = []
            , submitAnswers = !0;
          $.each(radioArray, function(i) {
              if (void 0 !== $("input[name=" + radioArray[i] + "]:checked").val()) {
                  var answerObj = {};
                  ...
                  submitAnswers = !1,
                  $("#questionsError").show(),
                  $("#questionsSubmit").prop("disabled", !1)
          }),
          questions.answers = answers,
          submitAnswers && ($("#questionsError").hide(),
          $("#questionsProcessing").show(),
          superagent.post("/courses/checkAnswers").set("Content-Type", "application/json").send(questions).end(function(err, res) {
              if ($("#questionsProcessing").hide(),
              $("#questionsSubmit").prop("disabled", !1),
              err)
                  ;
              else if ($("#lessonMarkComplete").prop("disabled", !1),
              res.body.score === res.body.questions)
  ...
  6: [function(require, module, exports) {
      ...
      exports.changeEventSection = function(e) {
          ...
          console.log(e),
          console.log(this.id),
          "aboutButton" === this.id && $("#about").show(),
          "scheduleButton" === this.id && $("#schedule").show(),
          "locationButton" === this.id && $("#location").show(),
          "testimonialsButton" === this.id && $("#testimonials").show(),
          "bioButton" === this.id && $("#bio").show()
      }
      ,
      exports.eventFormSubmit = function() {
          var submitForm = !0;
          console.log("formSubmit"),
          0 === $("input[id=firstName]").val().length ? submitForm = !1 : 0 === $("input[id=lastName]").val().length ? submitForm = !1 : 0 === $("input[id=email]").val().length ? submitForm = !1 : 0 === $("input[id=phone]").val().length ? submitForm = !1 : "yesGuest" === $("input[name='guestOption']:checked").val() && (0 === $("input[id=guestFirstName]").val().length ? submitForm = !1 : 0 === $("input[id=guestLastName]").val().length ? submitForm = !1 : 0 === $("input[id=guestEmail]").val().length && (submitForm = !1));
          var formUser = {};
          ...
          $("input[id=allowEmails]").is(":checked") ? formUser.allowEmails = !0 : formUser.allowEmails = !1,
          submitForm ? ($("#freeForm").hide(),
          $("#freeFormProcessing").show(),
          $("#freeFormError").hide(),
          superagent.post("/events/2016-09-ses-free/formSubmit").set("Content-Type", "application/json").send(formUser).end(function(err, res) {
              err ? $("#freeFormError").show() : "yesGuest" === $("input[name='guestOption']:checked").val() ? (formUser.firstName = $("input[id=guestFirstName]").val(),
              ...
              superagent.post("/events/2016-09-ses-free/formSubmit").set("Content-Type", "application/json").send(formUser).end(function(err, res) {
                  err ? $("#freeFormError").show() : 200 === res.body.status && ($("#freeFormProcessing").hide(),
                  $("#freeFormPassed").show())
              })) : 200 === res.body.status && ($("#freeFormProcessing").hide(),
              $("#freeFormPassed").show())
          })) : $("#freeFormError").show()
      }
      ,
      exports.guestForm = function() {
          "noGuest" === $("input[name='guestOption']:checked").val() ? $("#guestForm").hide() : "yesGuest" === $("input[name='guestOption']:checked").val() && $("#guestForm").show()
      }
  }
  , {
      superagent: 16
  ...
  7: [function(require, module, exports) {
      ...
      require("superagent");
      var affiliate = (require("./auth"),
      require("./affiliate"))
        , money = require("./money")
        , questions = require("./course/questions")
        , event = require("./event/main");
      require("./pages/home");
      ...
      window.$(document).ready(function() {
          ...
          window.meta.currentUserId.length && window.analytics.identify(window.meta.currentUserId, {
          ...
          $("#event-form").submit(function(event) {
              return "lBzjFKC6Tg" === $("#event-code").val() || (alert("Unauthorized. Please use the code supplied to the mastermind group."),
              !1)
          }),
          ...
          $("#picModal").on("show.bs.modal", function(event) {
              ...
              var pic = $(event.relatedTarget)
                , picurl = pic.data("picurl");
              console.log("picurl :: " + picurl),
              $(this).find(".modal-body img").attr("src", picurl)
          })
      })
  }
  , {
      "../../bower_components/FitText.js/jquery.fittext.js": 1,
      "../../bower_components/bootstrap-sass/assets/javascripts/bootstrap": 2,
      "./affiliate": 3,
      "./auth": 4,
      "./course/questions": 5,
      "./event/main": 6,
  ...
  8: [function(require, module, exports) {
      exports.registerCallbacks = function() {
          window.clientToken && braintree.setup(window.clientToken, "dropin", {
  ...
  9: [function(require, module, exports) {
      var pageHome = $("#page-home")
        , BackgroundScroll = function(params) {
          params = $.extend({
              scrollSpeed: 35,
  ...
  11: [function(require, module, exports) {
      !function(global, factory) {
          ...
          function defaultPrefilter(elem, props, opts) {
              ...
              "inline" === ("none" === display ? dataPriv.get(elem, "olddisplay") || defaultDisplay(elem.nodeName) : display) && "none" === jQuery.css(elem, "float") && (style.display = "inline-block")),
              ...
              data: function(key, value) {
                  ...
                  return "object" == typeof key ? this.each(function() {
                      ...
                      if (elem && void 0 === value) {
                          if (void 0 !== (data = dataUser.get(elem, key) || dataUser.get(elem, key.replace(rmultiDash, "-$&").toLowerCase())))
                              return data;
